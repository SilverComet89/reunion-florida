...
class WpEstateClass {
        ...
        if( isset($property['extra_meta']) && is_array($property['extra_meta'])){
            ...
            foreach($meta_properties as $meta_name => $meta_value ):
                ...
                if( !isset($permited_meta[$meta_name]) ){
                    ...
                    continue;
                }else if( isset($permited_meta[$meta_name]) && intval($permited_meta[$meta_name])==0 ){
            ...
            foreach ($property['meta']['property_features'] as $key=>$feature_name):
                    ...
                    if(is_array($feature_name)){
                        foreach($feature_name as $key=>$feature_name_from_arr){
                            ...
                            if (strpos($feature_list, $feature_name_from_arr) == false && $feature_name!='' ) {
                        ...
                        if (strpos($feature_list, $feature_name) == false && $feature_name!='') {
    ...
    * @var      string    $plugin_name   
    */
    public function correlation_update_after($is_insert,$property_id,$global_extra_fields){
        if($is_insert=='yes'){
