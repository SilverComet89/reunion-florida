...
class Mlsimport {
    ...
    private function load_dependencies() {
         ...
         * core plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-mlsimport-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-mlsimport-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-mlsimport-admin.php';
         ...
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-mlsimport-item.php';
         ...
         * side of the site.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-mlsimport-public.php';
    ...
    public function get_plugin_data($what) {
        ...
        if (isset($plugin_data['mls_enviroment']) && $plugin_data['mls_enviroment'] == 'TresleReso' && $what == 'server_token') {
