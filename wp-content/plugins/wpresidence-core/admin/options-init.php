...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            ...
            'subtitle' => __('This applies to all register forms.', 'wpresidence-core'),
            'options' => array(
                'yes' => 'yes',
                'no' => 'no'
            ),
        ...
        array(
            ...
            'class' => 'class_visible_user_role',
            'required' => array('wp_estate_visible_user_role_dropdown', '=', 'yes'),
            'title' => __('Select wich user type admin should approve manually', 'wpresidence-core'),
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'subtitle' => __('In order to be abosoltly centered the logo and user menu area have to be the same size - in px.', 'wpresidence-core'),
            'default' => '290'
        ),
        ...
        array(
            ...
            'subtitle' => __('Works only for Header Image!', 'wpresidence-core'),
            'options' => array(
                'yes' => 'yes',
                'no' => 'no',
            ),
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'subtitle' => __('Where to show the sidebar on the agent page type 1. Applies when agent registers throgh theme register form.', 'wpresidence-core'),
            'options' => array(
                'no sidebar' => __('no sidebar', 'wpresidence-core'),
                'right' => __('right', 'wpresidence-core'),
                'left' => __('left', 'wpresidence-core')
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type' => 'color',
            'title' => __('Breadcrumbs, Forms , Blog Meta and Second Line Font Color', 'wpresidence-core'),
            'subtitle' => __('Breadcrumbs, Forms, Blog Meta and Second Line Font Color', 'wpresidence-core'),
            'transparent' => false,
        ),
        array(
...
Redux::setSection($opt_name, array(
    'title' => __('Agent Card & Blog Card Design', 'wpresidence-core'),
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'subtitle' => __('Applies only with Theme Options search form when it is added to the the page set as homepage.', 'wpresidence-core'),
            'options' => array(
                'yes' => 'yes',
                'no' => 'no'
            ),
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        array(
            ...
            'subtitle' => __('Applies when search form display is set to float mode over the hero header', 'wpresidence-core'),
            'transparent' => false,
        ),
        array(
        ...
        array(
            ...
            'subtitle' => __('Applies when search form display is set to float mode over the hero header for Features and', 'wpresidence-core'),
            'transparent' => false,
        ),
        array(
            ...
            'subtitle' => __('Advanced Search Button Background Color', 'wpresidence-core'),
            'transparent' => false,
        ),
        array(
            'id' => 'wp_estate_adv_search_tab_font_color',
            'type' => 'color',
            'title' => __('Tab Font Color in Advanced Search', 'wpresidence-core'),
            'subtitle' => __('Applies to non active tabs with Search type 6 and 8.', 'wpresidence-core'),
            'transparent' => false,
        ),
        array(
            'id' => 'wp_estate_adv_search_tab_back_font_color',
            'type' => 'color',
            'title' => __(' Tab Background Color in Advanced Search', 'wpresidence-core'),
            'subtitle' => __('Applies to non active tabs with Search type 6 and 8.', 'wpresidence-core'),
            'transparent' => false,
        ),
        array(
            ...
            'type' => 'color',
            'title' => __('Advanced Search Hover Font Color', 'wpresidence-core'),
            'subtitle' => __('Applies to all forms, dropdowns and input search fields', 'wpresidence-core'),
            'transparent' => false,
        ),
        array(
            'id' => 'wp_estate_adv_search_background_color',
            'type' => 'color',
            'title' => __('Advanced Search Hover Background Color', 'wpresidence-core'),
            'subtitle' => __('Applies to all forms, dropdowns and input search fields', 'wpresidence-core'),
            'transparent' => false,
        ),
    ),
