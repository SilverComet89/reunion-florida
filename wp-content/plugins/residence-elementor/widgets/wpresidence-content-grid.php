...
class Wpresidence_Content_grid extends Widget_Base {
    ...
    public function get_title() {
        return __('WpResidence Content Grid', 'residence-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'label' => esc_html__('Main Item Adress Typography', 'residence-elementor'),
                    'scheme' => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'label' => esc_html__('Secondary Item Adress/Details Typography', 'residence-elementor'),
                    'scheme' => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_1,
