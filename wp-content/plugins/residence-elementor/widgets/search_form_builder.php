...
class Wpresidence_Search_Form_Builder extends Widget_Base {
    ...
    $this->add_control(
        ...
        $repeater->add_control(
                'field_how', [
            'label' => esc_html__('How it will Compare', 'residence-elementor'),
            'type' => Controls_Manager::SELECT,
            'options' => array(
                'equal' => 'equal',
                'greater' => 'greater',
        ...
        $this->add_group_control(
            ...
            'selector' => '{{WRAPPER}} .form-control, {{WRAPPER}} input.form-control,{{WRAPPER}} .wpestate-multiselect-custom-style,{{WRAPPER}} .btn.wpestate-multiselect-custom-style',
            'scheme' => \Elementor\Core\Schemes\Typography::TYPOGRAPHY_3,
                ]
        );
